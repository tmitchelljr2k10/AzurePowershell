...
Write-Host "   "
Write-Host "   storagename must be unique and cannot inlcude any spaces or capital letters"
...
Write-Host "   "
Write-Host "   "
Write-Host "   If you have not modified the script yet, please hit N below and edit the script with your own values before running it again."
Write-Host "   "
